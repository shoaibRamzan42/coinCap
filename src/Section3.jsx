  ...
  return (
    ...
    <div className='py-5 border-b flex justify-between items-center font-custom '>
      <div className='flex gap-4 items-center'>
        <button className='text-[#3861fb] font-bold  p-2 rounded-md  items-center bg-[#3861fb]/10 text-[12px] gap-1 flex'><img className='w-3 h-3' src="https://www.clipartmax.com/png/small/261-2613569_the-icon-is-a-square-composed-of-four-separate-sized-collage-icon.png" alt="pic" />
        Cryptocurrencies</button>
        <button className='text-[#58667e] font-extrabold  p-2 rounded-md  items-center hover:bg-gray-100 text-[12px] gap-1 flex'><img className='w-3 h-3' src="https://www.pikpng.com/pngl/m/541-5410770_png-file-svg-categories-icon-png-clipart.png" alt="pic" />
        Categories</button>
        <h1>|</h1>
        <button className='text-[#58667e] font-extrabold  p-2 rounded-md  items-center hover:bg-gray-100 text-[12px] gap-1 flex'>🏆
